...
{
    [HideInInspector] public int valveMapping;
    GameObject UI;
    ...
    private void Awake()
    {
        UI = GameObject.Find("Show Selector/UI");
    ...
    public InputDataObj InputCheck()
    {
        ...
        if (valveMapping > 0)
        {
            ...
            {
                if (programmingGroups.recordingGroups[valveMapping - 1].inputNames[i].index > 0)
                {
                    bool applyKey = false;
                    ...
                    switch (i)
                    {
                        ...
                        case 29:
                            ...
                            break;
                        case 30:
                            if (Input.GetKey(KeyCode.Less)) { applyKey = true; }
                            break;
                        case 31:
                            if (Input.GetKey(KeyCode.Greater)) { applyKey = true; }
                            break;
                        case 32:
                    ...
                    if (!programmingGroups.recordingGroups[valveMapping - 1].inputNames[i].drawer)
                    {
                        ...
                        if (applyKey)
                        {
                            ...
                            for (int e = 0; e < programmingGroups.recordingGroups[valveMapping - 1].inputNames[i].index; e++)
                            {
                                frameInputs.topDrawer[programmingGroups.recordingGroups[valveMapping - 1].inputNames[i].index - 1] = true;
                            }
                        }
                    }
                    else
                    {
                        ...
                        if (applyKey)
                        {
                            ...
                            for (int e = 0; e < programmingGroups.recordingGroups[valveMapping - 1].inputNames[i].index; e++)
                            {
                                frameInputs.bottomDrawer[programmingGroups.recordingGroups[valveMapping - 1].inputNames[i].index - 1] = true;
                            }
                        }
                    }
                }
        ...
        else
        {
            ...
            {
                if (editorKeys.inputNames[i].index > 0)
                {
                    bool applyKey = false;
                    ...
                    if (!editorKeys.inputNames[i].drawer)
                    {
                        ...
                        {
                            frameInputs.anyButtonHeld = true;
                            for (int e = 0; e < editorKeys.inputNames[i].index; e++)
                            {
                                frameInputs.topDrawer[editorKeys.inputNames[i].index - 1] = true;
                            }
                        }
                    }
                    else
                    {
                        ...
                        if (applyKey)
                        {
                            ...
                            for (int e = 0; e < editorKeys.inputNames[i].index;  e++)
                            {
                                frameInputs.bottomDrawer[editorKeys.inputNames[i].index - 1] = true;
                            }
                        }
                    }
                }
